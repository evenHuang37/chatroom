...
<div id="Layer1" style="position:absolute; width:100%; height:100%; z-index:-1">    
    ...
    <div class="title">
        <div class="am-g am-g-fixed">
            <div class="am-u-sm-12">
                <h1 class="am-text-primary">Public ChatRoom（公聊）</h1>
            </div>
        </div>
    </div>
    <!-- title end -->
    ...
    <div class="chat-content">
        <div class="am-g am-g-fixed chat-content-container" style=" height: 250px">
            <div class="am-u-sm-12">
            ...
            <div class="am-u-sm-12">
                <form class="am-form">
                    <div class="am-form-group">
                        <script type="text/plain" id="myEditor" style="width: 100%;height: 5rem;"></script>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        $(function() {
            ...
            // 使昵称框获取焦点
            $('#nickname')[0].focus();
            var socket = new WebSocket('ws://${pageContext.request.getServerName()}:${pageContext.request.getServerPort()}${pageContext.request.contextPath}/web');
