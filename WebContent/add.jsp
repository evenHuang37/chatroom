...
<body>
	...
	<header class="navbar clearfix" id="header">
		<div class="container">
				<div class="navbar-brand">
					<!-- COMPANY LOGO -->				
					<a href="index.html">
						<span style="color:#FFFFFF">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ChatRoom</span>				
					</a>
					<!-- /COMPANY LOGO -->
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown user" id="header-user">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img alt="" src="cl/img/avatars/avatar3.jpg" />
	...
	<section id="page">
				...
				<div id="sidebar" class="sidebar">
					<div class="sidebar-menu nav-collapse">
						...
						<!-- SIDEBAR MENU -->
						<ul>							
							<li><a class="" href="user.jsp"><i class="fa fa-pencil-square-o fa-fw"></i> <span class="menu-text">user page</span></a></li>					
                            <li class="has-sub">
								<a href="javascript:;" class="">
								<i class="fa fa-envelope-o fa-fw"></i> <span class="menu-text">chat</span>
								<span class="arrow"></span>
								</a>
								<ul class="sub">
									<li><a class="" href="chat.jsp"><span class="sub-menu-text">public chat</span></a></li>
									<li><a class="" href="privacy.jsp"><span class="sub-menu-text">privacy chat</span></a></li>
								</ul>
							</li>
							<li><a class="" href="log.jsp"><i class="fa fa-th-large fa-fw"></i> <span class="menu-text">logging</span></a></li>	
                            <li><a class="" href="signin.jsp"><i class="fa fa-briefcase fa-fw"></i> <span class="menu-text">exit</span></a></li>
						</ul>
						<!-- /SIDEBAR MENU -->
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<!-- /PAGE HEADER -->
                        	<!-- PAGE MAIN CONTENT -->
                        <div>   <jsp:include page="privacyindex.jsp" flush="true"/></div>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- SLIMSCROLL -->
	<script type="text/javascript" src="cl/js/jQuery-slimScroll-1.3.0/jquery.slimscroll.min.js"></script><script type="text/javascript" src="cl/js/jQuery-slimScroll-1.3.0/slimScrollHorizontal.min.js"></script>
	<!-- COOKIE -->
	<script type="text/javascript" src="cl/js/jQuery-Cookie/jquery.cookie.min.js"></script>
	<!-- CUSTOM SCRIPT -->
